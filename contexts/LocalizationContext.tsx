...
const translations: Record<Locale, Translations> = {
  en: {
    ...
    status: 'Status',
    fileScan: 'File Scan',
    fileScan_placeholder: 'Select or drop a file to scan (PCAP, EXE, DOC, etc.)',
    error_selectFile: 'Please select a file to scan.',
    uploadingFile: 'Uploading {fileName}...',
    analysisPending: 'File uploaded. Waiting for analysis to complete...',
    analysisInProgress: 'Analysis in progress... This can take several minutes.',
    analysisCompleteFetchingReport: 'Analysis complete. Fetching full report...',
    scanCompleteForFile: 'Scan complete for {fileName}.',
    pcapAnalysis: 'PCAP Analysis',
    idsRules: 'IDS Rules',
    contactedDomains: 'Contacted Domains',
    contactedIPs: 'Contacted IPs',
    summary: 'Summary',
    // User Agent Analyzer
  ...
  ar: {
    ...
    status: 'الحالة',
    fileScan: 'فحص ملف',
    fileScan_placeholder: 'حدد أو أسقط ملفًا لفحصه (PCAP, EXE, DOC, إلخ)',
    error_selectFile: 'يرجى تحديد ملف لفحصه.',
    uploadingFile: 'جاري رفع {fileName}...',
    analysisPending: 'تم رفع الملف. في انتظار اكتمال التحليل...',
    analysisInProgress: 'التحليل قيد التقدم... قد يستغرق هذا عدة دقائق.',
    analysisCompleteFetchingReport: 'اكتمل التحليل. جاري جلب التقرير الكامل...',
    scanCompleteForFile: 'اكتمل فحص {fileName}.',
    pcapAnalysis: 'تحليل PCAP',
    idsRules: 'قواعد كشف التسلل',
    contactedDomains: 'النطاقات المتصل بها',
    contactedIPs: 'عناوين IP المتصل بها',
    summary: 'ملخص',
    // User Agent Analyzer
